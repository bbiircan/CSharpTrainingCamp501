...
namespace CSharpTrainingCamp501
{
    public partial class Form1 : Form
    {
        ...
        SqlConnection connection = new SqlConnection("Server=localhost;initial Catalog=TrainingCamp501Db; integrated security=true;");
        ...
        private async void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show("The new book has been successfully added.");
        ...
        private async void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            await connection.ExecuteAsync(query,parameters);
            MessageBox.Show("The new book has been successfully deleted.");
        }
        ...
        private async void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            parameters.Add("@productId", txtProductId.Text);
            await connection.ExecuteAsync(query, parameters);
            MessageBox.Show("The new book has been successfully updated.", "Update", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
